...
print(result.data.stdout)  # "Internet blocked"
```
...
print("Public IP:", result.data.stdout)
```
...
print("GitHub API:", allowed.data.stdout)
```
...
print("Facebook:", blocked.data.stdout)  # "Blocked"
```
